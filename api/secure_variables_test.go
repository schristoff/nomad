...
func TestSecureVariables_SimpleCRUD(t *testing.T) {
	...
	t.Run("2 create sv1", func(t *testing.T) {
		...
		assert.NoError(t, err) // asserting this until create and update return secure variables from the server side
		get, _, err := nsv.Read(sv1.Path)
